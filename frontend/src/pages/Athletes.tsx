    ...
    <>
      ...
      {athletes.length === 0 && !loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              ...
              <div className="relative z-10">
                ...
                <div>
                  <div className="flex justify-between items-end mb-1">
                   ...
                   <div className="h-1.5 w-full bg-progress-track rounded-full overflow-hidden mb-4">
                    <div
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    <div className="bg-score-card rounded-lg p-2 border border-score-card-border text-center overflow-hidden">
                      ...
                      <>
                        {athlete.plan_status === 'expired' || athlete.plan_status === 'expiring' ? (
                          <button
                            ...
                            className="text-sm text-amber-500 hover:text-amber-400 transition-colors flex items-center gap-1 font-inter"
                          >
          ...
          {isAdmin && (
            <div
              className="glass-panel rounded-xl p-6 flex items-center justify-center border-dashed border-border-subtle hover:border-primary/50 cursor-pointer transition-colors min-h-[160px]"
              onClick={() => {
                setSelectedAthlete(null);
                setFormModalOpen(true);
              }}
